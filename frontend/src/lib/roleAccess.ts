...
export const ROLE_ACCESS_CONFIG: Record<string, RoleAccessConfig> = {
    SUPER_ADMIN: {
        ...
        allowedPrefixes: ['/dashboard', '/personnel', '/parametres', '/classes', '/eleves', '/enseignants', '/familles', '/communication', '/examens', '/emploi-du-temps', '/matieres', '/notes', '/bulletins', '/evenements', '/activites', '/archive', '/fournitures', '/galerie', '/centre-evaluation', '/salle-des-profs', '/comptabilite'],
        tier: 'full-admin',
    ...
    DIRECTEUR_NIVEAU: {
        ...
        redirectPath: '/dashboard',
        allowedPrefixes: ['/dashboard', '/personnel', '/classes', '/eleves', '/enseignants', '/familles', '/communication', '/examens', '/emploi-du-temps', '/matieres', '/notes', '/bulletins', '/evenements', '/salle-des-profs'],
        tier: 'full-admin',
        hasSystemAccess: true,
