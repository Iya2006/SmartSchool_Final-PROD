...
export const ROLE_ACCESS_CONFIG: Record<string, RoleAccessConfig> = {
    SUPER_ADMIN: {
        ...
        allowedPrefixes: ['/dashboard', '/profil', '/personnel', '/parametres', '/classes', '/eleves', '/enseignants', '/familles', '/communication', '/examens', '/emploi-du-temps', '/matieres', '/notes', '/bulletins', '/evenements', '/activites', '/archive', '/fournitures', '/galerie', '/centre-evaluation', '/salle-des-profs', '/comptabilite', '/monitoring', '/selection-etablissement'],
        tier: 'full-admin',
    ...
    FONDATEUR: {
        ...
        label: 'Fondateur',
        redirectPath: '/dashboard',
        allowedPrefixes: ['/dashboard', '/profil', '/personnel', '/parametres', '/classes', '/eleves', '/enseignants', '/familles', '/communication', '/examens', '/emploi-du-temps', '/matieres', '/notes', '/bulletins', '/evenements', '/activites', '/archive', '/fournitures', '/galerie', '/centre-evaluation', '/salle-des-profs', '/comptabilite', '/monitoring'],
        tier: 'full-admin',
        hasSystemAccess: true,
    ...
    DIRECTEUR_NIVEAU: {
        ...
        redirectPath: '/dashboard',
        allowedPrefixes: ['/dashboard', '/profil', '/personnel', '/classes', '/eleves', '/enseignants', '/familles', '/communication', '/examens', '/emploi-du-temps', '/matieres', '/notes', '/bulletins', '/evenements', '/salle-des-profs', '/monitoring'],
        tier: 'full-admin',
        hasSystemAccess: true,
