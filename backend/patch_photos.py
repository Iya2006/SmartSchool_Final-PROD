...
filepath = r"c:\Users\hp\SMART_SCHOOL_FINAL\backend\app\api\photos.py"
with open(filepath, "r", encoding="utf-8") as f:
    content = f.read()

# Replace import
content = content.replace("from app.models.academique import Eleve, Enseignant, Parent", "from app.models.academique import Eleve, Enseignant, Parent, PhotoEnAttente")
...
for i, line in enumerate(lines):
    if line.startswith("# ================================================================"):
        if i + 1 < len(lines) and "UPLOAD" in lines[i+1]:
            # This is the upload section start. We will keep everything up to here.
            new_content.extend(lines[:i])
            break

# Now we append the rewritten upload methods and the new validation endpoints
new_content.append("""# ================================================================
