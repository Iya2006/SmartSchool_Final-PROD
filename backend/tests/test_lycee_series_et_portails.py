...
class TestGetLyceeSeriesCoefficients:
    ...
    def test_avec_token_non_admin_retourne_403(self, client: TestClient):
        ...
        with patch("app.core.auth.decode_token", return_value={"role": "ENSEIGNANT", "sub": "99", "type": "admin"}):
            response = client.get(
    ...
    def test_avec_token_admin_retourne_200(self, client: TestClient):
        ...
        with patch("app.core.auth.decode_token", return_value={"role": "ADMIN", "sub": "1", "type": "admin"}):
            response = client.get(
                "/api/classes/lycee-series-coefficients",
    ...
    def test_super_admin_retourne_200(self, client: TestClient):
        ...
        with patch("app.core.auth.decode_token", return_value={"role": "SUPER_ADMIN", "sub": "1", "type": "admin"}):
            response = client.get(
                "/api/classes/lycee-series-coefficients",
    ...
    def test_fondateur_retourne_200(self, client: TestClient):
        ...
        with patch("app.core.auth.decode_token", return_value={"role": "FONDATEUR", "sub": "1", "type": "admin"}):
            response = client.get(
                "/api/classes/lycee-series-coefficients",
                headers={"Authorization": "Bearer fake_token"},
            )
...
class TestPutLyceeSeriesCoefficients:
    ...
    def test_serie_sm_retourne_200(self, client: TestClient):
    ...
    def test_serie_se_retourne_200(self, client: TestClient):
    ...
    def test_serie_ss_retourne_200(self, client: TestClient):
    ...
    def test_serie_minuscule_acceptee(self, client: TestClient):
    ...
    def test_reponse_contient_message_et_serie(self, client: TestClient):
    ...
    def test_role_enseignant_retourne_403(self, client: TestClient):
        ...
        with patch("app.core.auth.decode_token", return_value={"role": "ENSEIGNANT", "sub": "5", "type": "admin"}):
            response = client.put(
                "/api/classes/lycee-series-coefficients/SM",
                json=self.VALID_UPDATE,
                headers={"Authorization": "Bearer fake_token"},
